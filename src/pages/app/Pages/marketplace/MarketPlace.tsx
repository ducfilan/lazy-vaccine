...
import MarketplaceSider from "../../components/MarketplaceSider"
import SeedItemCard from "../../components/SeedItemCard"
                ...
                totalSeedsCount ? (
                  <>
                    <Row justify="space-between">
                      <Col >
                        <Typography.Title level={3}>{totalSeedsCount} {i18n("marketplace_seeds")}</Typography.Title>
                      </Col>
                      <Col>
